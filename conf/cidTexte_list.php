<?php
// Numéro cIDTexte -	Nom complet -	Nom abrégé	- code legi-php
$cidTexte_list = array(
  'code_instruments_monetaires_medailes'=>[
    'cIDTexte' => 'LEGITEXT000006070666',
    'short_name' => 'code_instruments_monetaires_medailes',
    'full_name' => 'Code des instruments monétaires et des médailles',
    'code_legiphp' => 'C_06070666',
  ],

  'code_action_sociale_familles' => [
    'cIDTexte' => 'LEGITEXT000006074069',
    'short_name' => 'code_action_sociale_familles',
    'full_name' => 'Code de l\'action sociale et des familles',
    'code_legiphp' => 'C_06074069',
  ],

  'code_artisanat' => [
    'cIDTexte' => 'LEGITEXT000006075116',
    'short_name' => 'code_artisanat',
    'full_name' => 'Code de l\'artisanat',
    'code_legiphp' => 'C_06075116',
  ],

  'code_assurances' => [
    'cIDTexte' => 'LEGITEXT000006073984',
    'short_name' => 'code_assurances',
    'full_name' => 'Code des assurances',
    'code_legiphp' => 'C_06073984',
  ],

  'code_aviation_civile' => [
    'cIDTexte' => 'LEGITEXT000006074234',
    'short_name' => 'code_aviation_civile',
    'full_name' => 'Code de l\'aviation civile',
    'code_legiphp' => 'C_06074234',
  ],

  'code_cinema_image_animee' => [
    'cIDTexte' => 'LEGITEXT000020908868',
    'short_name' => 'code_cinema_image_animee',
    'full_name' => 'Code du cinéma et de l\'image animée',
    'code_legiphp' => 'C_20908868',
  ],

  'code_civil' => [
    'cIDTexte' => 'LEGITEXT000006070721',
    'short_name' => 'code_civil',
  ...
  'code_consommation' => [
    ...
    'short_name' => 'code_consommation',
    'full_name' => 'Code de la consommation',
    'code_legiphp' => 'C_06069565',
  ],

  'code_education' => [
    'cIDTexte' => 'LEGITEXT000006071191',
    'short_name' => 'code_education',
    'full_name' => 'Code de l\'éducation',
    'code_legiphp' => 'C_06071191',
  ],

  'code_electoral' => [
    'cIDTexte' => 'LEGITEXT000006070239',
    'short_name' => 'code_electoral',
    'full_name' => 'Code électoral',
    'code_legiphp' => 'C_06070239',
  ],

  'code_travail' => [
    'cIDTexte' => 'LEGITEXT000006072050',
    'short_name' => 'code_travail',
  ...
  'code_construction_habitation' => [
    ...
    'short_name' => 'code_construction_habitation',
    'full_name' => 'Code de la construction et de l\'habitation',
    'code_legiphp' => 'C_06074096',
  ],

  'code_defense' => [
    'cIDTexte' => 'LEGITEXT000006071307',
    'short_name' => 'code_defense',
    'full_name' => 'Code de la défense',
  ...
  'code_domaine_etat' => [
    ...
    'short_name' => 'code_domaine_etat',
    'full_name' => 'Code du domaine de l\'Etat',
    'code_legiphp' => 'C_06070208',
  ],

  'code_famille_aide_sociale' => [
    'cIDTexte' => 'LEGITEXT000006072637',
    'short_name' => 'code_famille_aide_sociale',
    'full_name' => 'Code de la famille et de l\'aide sociale',
    'code_legiphp' => 'C_06072637',
  ],

  'code_sport' => [
    'cIDTexte' => 'LEGITEXT000006071318',
    'short_name' => 'code_sport',
    'full_name' => 'Code du sport',
    'code_legiphp' => 'C_06071318',
  ],

  'code_tourisme' => [
    'cIDTexte' => 'LEGITEXT000006074073',
    'short_name' => 'code_tourisme',
    'full_name' => 'Code du tourisme',
    'code_legiphp' => 'C_06074073',
  ],

  'code_transports' => [
    'cIDTexte' => 'LEGITEXT000023086525',
    'short_name' => 'code_transports',
    'full_name' => 'Code des transports',
    'code_legiphp' => 'C_23086525',
  ],

  'code_sante_publique' => [
    'cIDTexte' => 'LEGITEXT000006072665',
    'short_name' => 'code_sante_publique',
    'full_name' => 'Code de la santé publique',
    'code_legiphp' => 'C_06072665',
  ],

  'code_securite_interieure' => [
    'cIDTexte' => 'LEGITEXT000025503132',
    'short_name' => 'code_securite_interieure',
    'full_name' => 'Code de la sécurité intérieure',
    'code_legiphp' => 'C_25503132',
  ],

  'code_securite_sociale' => [
    'cIDTexte' => 'LEGITEXT000006073189',
    'short_name' => 'code_securite_sociale',
    'full_name' => 'Code de la sécurité sociale',
